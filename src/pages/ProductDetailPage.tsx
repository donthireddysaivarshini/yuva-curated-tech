...
// Variant pricing table: [ramOption, storageOption] -> price delta
...
const ProductDetailPage = () => {
  ...
  // Derive initial RAM/Storage from product specs
  ...
  const variantPrice = useMemo(() => {
    ...
    const selectedDeltaRam = variantPriceDelta[selectedRam] || 0;
    const selectedDeltaStorage = variantPriceDelta[selectedStorage] || 0;
    return product.price + (selectedDeltaRam - baseDeltaRam) + (selectedDeltaStorage - baseDeltaStorage);
        ...
        <div className="mt-16">
          ...
          <div className="mt-8 grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-surface-low rounded-2xl p-6">
              ...
              <button className="mt-6 w-full bg-card text-foreground py-3 rounded-xl font-display font-semibold text-sm ghost-border hover:bg-accent/50 transition-colors inline-flex items-center justify-center gap-2">
