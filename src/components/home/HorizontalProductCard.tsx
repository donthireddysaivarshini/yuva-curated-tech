  ...
  return (
    <div className="group bg-card rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 flex flex-row md:flex-col h-full border border-border/40">
      ...
      <div className="p-3 md:p-4 flex flex-col flex-1">
        ...
        <p className="text-[9px] md:text-[10px] text-muted-foreground font-medium uppercase tracking-wider mb-0.5 md:mb-1">
          {product.brand_name}
        </p>

        <Link to={`/product/${product.slug}`}>
          <h3 className="font-display font-bold text-foreground text-xs md:text-sm leading-tight line-clamp-2 hover:text-primary transition-colors">
            {product.title}
          </h3>
        </Link>
